...
| `pnpm audit --audit-level high`  | **当前阻断：0 个严重、2 个高危** | 2026-07-31 Batch 2 已移除 Prisma 的 `find-my-way` 与 `valibot` 公告；Batch 3/4 剩余阻断及当前机器可读计数记录在 [`dependency-audit.md`](dependency-audit.md)。不得降低阈值或忽略退出码。 |
