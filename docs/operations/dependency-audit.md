...
| `GHSA-mh99-v99m-4gvg`                        | HIGH     | 16 条路径，集中于 `minimatch>brace-expansion@1.1.16/2.1.2`；涵盖 Nest CLI、Taro CLI/runner/platform                            | `>=5.0.8`，已发布且 5.0.8 已安全安装，但旧主版本仍存在 | 无兼容修复；旧父包限定 1.x/2.x                         | 等待 Nest/Taro 工具链淘汰旧 minimatch/glob                        |
