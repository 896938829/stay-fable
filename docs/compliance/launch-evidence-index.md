...
历史依赖审计基线为 2 critical、11 high；该计数仅用于保留旧证据契约，当前计数以下表为准。
...
| 微信（WeChat）原生项目编译与官方预览                                                                           | [`project.config.json`](../../wx/project.config.json)、[`app.json`](../../wx/app.json)、[`check-wx-project.mjs`](../../scripts/check-wx-project.mjs)、[`Slice 1 验证记录`](../verification/2026-07-29-slice-1-identity-search.md) | 受控证据库：`phase-0/miniapps/wechat/`；2026-07-29 当前 Slice 1 官方编译、核心自动化与预览已完成，受控归档和独立复核待完成   | In review   |
| Dependency audit: full 0 critical, 2 high, 1 moderate, 0 low; production 0 critical, 1 high, 0 moderate, 0 low | [`dependency-audit.md`](../operations/dependency-audit.md)、[`security-gates.md`](../operations/security-gates.md)                                                                                                                | 受控证据库：`phase-0/security/dependency-audit/`；Batch 2 已移除 Prisma 公告，Batch 3/4 剩余高危使发布门禁继续以非零状态退出 | Blocked     |
