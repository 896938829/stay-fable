...
| Dependency audit: full 0 critical, 3 high, 2 moderate, 0 low; production 0 critical, 2 high, 1 moderate, 0 low | [`dependency-audit.md`](../operations/dependency-audit.md)、[`security-gates.md`](../operations/security-gates.md)                                                                                                                | 受控证据库：`phase-0/security/dependency-audit/`；发布门禁仍以非零状态退出                                                 | Blocked     |
